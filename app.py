...
st.set_page_config(page_title="X-Ray Detector", layout="centered")
st.title("X-Ray Object Detection")
st.write("Upload an X-ray image and the model will detect and label objects.")
